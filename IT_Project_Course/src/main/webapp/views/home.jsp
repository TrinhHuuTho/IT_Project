...
<html lang="en">
  ...
  <body>
    ...
    <header class="header d-none d-lg-block">
      <!--Begin nav-->
      <!-- place navbar here -->
      <!--Nơi lưu đường liên kết đến các trang khác-->
      <nav class="navbar navbar-expand-lg navbar-dark header__navbar p-md-0">
        <div class="container">
          <a class="navbar-brand" href="${URL}views/home.jsp">
            <img
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-custom">
                  <li>
                    <a class="dropdown-item" href="category.html">Ngôn Tình</a>
                  </li>
                  <li>
                    <a class="dropdown-item" href="category.html">Trọng Sinh</a>
                  </li>
                  <li>
                    <a class="dropdown-item" href="category.html">Cổ Đại</a>
                  </li>
                  <li>
                    <a class="dropdown-item" href="category.html">Tiên Hiệp</a>
                  </li>
                  <li>
                    <a class="dropdown-item" href="category.html">Ngược</a>
                  </li>
                  <li>
                    <a class="dropdown-item" href="category.html">Khác</a>
                  </li>
                  <li>
                    <a class="dropdown-item" href="category.html">Dị Giới</a>
                  </li>
                  <li>
                  ...
                  <li>
                    <a class="dropdown-item" href="category.html">XuyênKhông</a>
                  </li>
                  <li>
                    <a class="dropdown-item" href="category.html">Sủng</a>
                  </li>
                  <li>
                    <a class="dropdown-item" href="category.html">Cung Đấu</a>
                  </li>
                  <li>
                    <a class="dropdown-item" href="category.html">Gia Đấu</a>
                  </li>
                </ul>
              </li>
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-custom">
                  <li><a class="dropdown-item" href="#">Dưới 100</a></li>
                  <li><a class="dropdown-item" href="#">100 - 500</a></li>
                  <li><a class="dropdown-item" href="#">500 - 1000</a></li>
                  <li><a class="dropdown-item" href="#">Trên 1000</a></li>
                </ul>
              </li>
            </ul>
        ...
        <div class="container-fluid">
          ...
          >
            <div class="offcanvas-header">
              <img
                src="${URL}assets/images/logo_text.png"
                alt="Logo Suu Truyen"
                srcset=""
                class="img-fluid"
                style="width: 200px"
    ...
    <div class="bg-light header-bottom">
      <div class="container py-1">
        <p class="mb-0">
          Đọc sách online. Tổng hợp đầy đủ và cập nhật liên tục.
        </p>
      </div>
    </div>
              ...
              <div class="section-stories-hot__list">
                ...
                <div class="story-item">
                  <a href="story.html" class="d-block text-decoration-none">
                    <div class="story-item__image">
                      <img
                        src="${URL}assets/images/ngao_the_dan_than.jpg"
                ...
                <div class="story-item">
                  <a href="story.html" class="d-block text-decoration-none">
                    <div class="story-item__image">
                      <img
                        src="${URL}assets/images/nang_khong_muon_lam_hoang_hau.jpg"
                ...
                <div class="story-item">
                  <a href="story.html" class="d-block text-decoration-none">
                    <div class="story-item__image">
                      <img
                        src="${URL}assets/images/kieu_sung_vi_thuong.jpg"
                ...
                <div class="story-item">
                  <a href="story.html" class="d-block text-decoration-none">
                    <div class="story-item__image">
                      <img
                        src="${URL}assets/images/linh_vu_thien_ha.jpg"
                ...
                <div class="story-item">
                  <a href="story.html" class="d-block text-decoration-none">
                    <div class="story-item__image">
                      <img
                        src="${URL}assets/images/anh_dao_ho_phach.jpg"
                ...
                <div class="story-item">
                  <a href="story.html" class="d-block text-decoration-none">
                    <div class="story-item__image">
                      <img
                        src="${URL}assets/images/than_dao_dan_ton.jpg"
                ...
                <div class="story-item">
                  <a href="story.html" class="d-block text-decoration-none">
                    <div class="story-item__image">
                      <img
                        src="${URL}assets/images/cuoi_truoc_yeu_sau_mong_tieu_nhi.jpg"
                ...
                <div class="story-item">
                  <a href="story.html" class="d-block text-decoration-none">
                    <div class="story-item__image">
                      <img
                        src="${URL}assets/images/me_dam.jpg"
                        alt="Mê Đắm"
                        class="img-fluid"
                        width="150"
                        height="230"
                ...
                <div class="story-item">
                  <a href="#" class="d-block text-decoration-none">
                    <div class="story-item__image">
                      <img
                        src="${URL}assets/images/khong_phu_the_duyen.jpg"
                ...
                <div class="story-item">
                  <a href="#" class="d-block text-decoration-none">
                    <div class="story-item__image">
                      <img
                        src="${URL}assets/images/diu_dang_tan_xuong.jpg"
                ...
                <div class="story-item">
                  <a href="#" class="d-block text-decoration-none">
                    <div class="story-item__image">
                      <img
                        src="${URL}assets/images/vo_chong_sieu_sao_hoi_ngot.jpg"
                ...
                <div class="story-item">
                  <a href="#" class="d-block text-decoration-none">
                    <div class="story-item__image">
                      <img
                        src="${URL}assets/images/that_u_that_u_phai_la_hong_phai_xanh_tham.jpg"
                ...
                <div class="story-item">
                  <a href="#" class="d-block text-decoration-none">
                    <div class="story-item__image">
                      <img
                        src="${URL}assets/images/thieu_tuong_vo_ngai_noi_gian_roi.jpg"
                ...
                <div class="story-item">
                  <a href="#" class="d-block text-decoration-none">
                    <div class="story-item__image">
                      <img
                        src="${URL}assets/images/cung_chieu_vo_nho_troi_ban.jpg"
                ...
                <div class="story-item">
                  <a href="#" class="d-block text-decoration-none">
                    <div class="story-item__image">
                      <img
                        src="${URL}assets/images/thien_huong_nguoi_mu_liec_mat_dua_tinh.jpg"
        ...
        <div class="row align-items-start">
                  ...
                  <div class="section-stories-new__list">
                    <div class="story-item-no-image">
                      ...
                      >
                        ...
                        <span class="badge text-bg-info text-light me-1"
                          >New</span
                        >

                        <span class="badge text-bg-success text-light me-1"
                          >Full</span
                        >
          ...
          <div class="col-12 col-md-4 col-lg-3 sticky-md-top">
            <div class="row">
              <div class="col-12">
                <div
                  class="section-list-category bg-light p-2 rounded card-custom"
                >
            ...
            <div class="col-12">
              <div class="section-stories-full__list">
                <div class="story-item-full text-center">
                  ...
                  <h3
                    class="fs-6 story-item-full__name fw-bold text-center mb-0"
                  >
                    <a
                      href="#"
                ...
                <div class="story-item-full text-center">
                  <a href="#" class="d-block story-item-full__image">
                    <img
                      src="${URL}assets/images/hat_de_va_chanel.jpg"
                ...
                <div class="story-item-full text-center">
                  <a href="#" class="d-block story-item-full__image">
                    <img
                      src="${URL}assets/images/em_anh_va_chung_ta.jpg"
                  ...
                  <span class="story-item-full__badge badge text-bg-success"
                    >Full - 105 chương</span
                  >
                </div>
                <div class="story-item-full text-center">
                  <a href="#" class="d-block story-item-full__image">
                    <img
                      src="${URL}assets/images/me_vo_khong_loi_ve.jpg"
          ...
          <div class="col-12">
            <a rel="license" href="http://creativecommons.org/licenses/by/4.0/"
              ><img
                ...
                src="${URL}assets/images/88x31.png" /></a
            ><br />
            <p>
