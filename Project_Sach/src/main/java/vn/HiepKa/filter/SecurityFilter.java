...
public class SecurityFilter implements Filter {
    ...
    private static final String[] STATIC_EXTENSIONS = { ".png", ".jpg", ".jpeg", ".gif", ".ico", ".css", ".js", ".pdf" };
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
        ...
        try {
            ...
            // Nếu người dùng là admin hoặc user (hệ thống tin tưởng người dùng), cho phép tiếp tục
