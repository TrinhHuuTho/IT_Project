                                ...
                                <table id="datatablesSimple">
                                    ...
                                    <c:forEach var="book" items="${books}">
                                        <tr>
                                            ...
                                            <td>
	                                            <a href="${pageContext.request.contextPath }/admin/edit?id=${book.bookid}" class="btn btn-primary btn-sm">
											        <i class="fas fa-edit"></i>
											    </a>
											    <a href="${pageContext.request.contextPath }/admin/delete?id=${book.bookid}" class="btn btn-danger btn-sm">
