      ...
      <div class="row">
        <div class="head-title-global d-flex justify-content-between mb-2">
          ...
          <div class="col-4 col-md-3 col-lg-2">
            <select class="form-select select-stories-hot" aria-label="Truyen hot" onchange="window.location.href='${pageContext.request.contextPath}/user/home?genreId=' + this.value">
          ...
          <div class="section-stories-hot__list">
            ...
            <c:if test="${book.status}">
              <div class="story-item">
                <a href="${pageContext.request.contextPath}/user/story?id=${book.bookid}" class="d-block text-decoration-none">
                    ...
                    <div class="story-item-no-image">
                      <div class="story-item-no-image__name d-flex align-items-center">
                        <h3 class="me-1 mb-0 d-flex align-items-center">
                          ...
                          <a href="${pageContext.request.contextPath}/user/story?id=${book.bookid}" class="text-decoration-none text-dark fs-6 hover-title text-one-row story-name">${book.title}</a>
                        </h3>
                        <span class="badge text-bg-info text-light me-1">New</span>
                      </div>
                      <div class="story-item-no-image__chapters ms-2">
                        <a href="${pageContext.request.contextPath}/user/story?id=${book.bookid}" class="hover-title text-decoration-none text-info">Ngày cập nhật ${book.getCreatedat()}</a>
                      </div>
                    </div>
                  </c:if>
                  </c:if>
            ...
            <div class="section-list-category bg-light p-2 rounded card-custom">
              ...
              <div class="row">
                <ul class="list-category">
                  <c:forEach var="genre" items="${genres}">
                    <li>
                      <a class="text-decoration-none text-dark hover-title" href="${pageContext.request.contextPath}/user/genreDetails?genreId=${genre.genreid}">
                        ${genre.genreName}
                      </a>
                    </li>
                  </c:forEach>
