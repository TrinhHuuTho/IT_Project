            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu dropdown-menu-custom">
                ...
                <c:forEach var="genre" items="${genres}">
                  <li>
                    <a class="dropdown-item" href="#">${genre.genreName}</a>
                  </li>
                </c:forEach>
              </ul>
            </li>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-12">
          ...
          <!-- Skeleton loading animation (ẩn khi có dữ liệu) -->
                    ...
                    <div class="story-item-no-image">
                      ...
                      <div class="story-item-no-image__chapters ms-2">
                        <a
                          ...
                          >Ngày cập nhật ${book.getCreatedat()}</a
                        >
                      </div>
                    </div>
                  </c:if>
                  ...
                  <c:forEach var="genre" items="${genres}">
                    <li>
                      <a
                        ...
                        href="${pageContext.request.contextPath}/genreDetails?genreId=${genre.genreid}"
                      >
                        ${genre.genreName}
                      </a>
                    </li>
